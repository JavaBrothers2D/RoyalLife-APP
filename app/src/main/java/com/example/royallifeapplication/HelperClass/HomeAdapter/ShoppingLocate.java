...
public class ShoppingLocate extends RecyclerView.Adapter<ShoppingLocate.FeaturedViewHoder> {

    ArrayList<FeaturedHelpersClass> featuredLocations;

    public ShoppingLocate(ArrayList<FeaturedHelpersClass> featuredLocations) {
