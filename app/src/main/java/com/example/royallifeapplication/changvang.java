...
public class changvang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_changvangmore);
        imgback = findViewById(R.id.backtoMenu3);
        bad1 = findViewById(R.id.changvang1);
        bad2 = findViewById(R.id.changvang2);
        bad3 = findViewById(R.id.changvang3);
        bad4 = findViewById(R.id.changvang4);
        bad5 = findViewById(R.id.changvang5);
        bad6 = findViewById(R.id.changvang6);
        bad7 = findViewById(R.id.changvang7);
        bad8 = findViewById(R.id.changvang8);
        bad9 = findViewById(R.id.changvang9);

        add = findViewById(R.id.changAdd);
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mapMethod method = new mapMethod();
                Intent intent = new Intent(android.content.Intent.ACTION_VIEW,
                        Uri.parse(getString(R.string.defaultSearchString)+ "Chang Vang Rooftop" +"/@"
        ...
        bad1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(changvang.this,
                        changvang.class);
                ...
                changvang.this.startActivity(intent);
            }
        });
